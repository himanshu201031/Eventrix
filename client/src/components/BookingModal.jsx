    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
            <motion.div
                ...
                className="relative flex max-h-[90vh] w-full max-w-xl flex-col overflow-hidden rounded-[2rem] border border-black/10 bg-white text-brand-dark shadow-2xl dark:border-dark-line dark:bg-dark-surface dark:text-dark-ink"
            >
                {/* Header */}
                <div className="relative bg-brand-purple p-6 text-white">
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <button
                            onClick={onClose}
                            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/15 text-white transition-all hover:bg-white/30"
                        >
                            <X className="h-4 w-4" />
                        </button>
                    </div>
                ...
                <div className="flex items-center justify-between border-t border-black/10 bg-brand-light p-6 dark:border-dark-line dark:bg-dark-surface-2">
                    ...
                    {step === 6 && (
                        <button onClick={onClose} className="btn-gradient w-full rounded-xl py-3 text-xs font-extrabold uppercase tracking-wider text-white">
